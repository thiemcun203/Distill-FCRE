...
class Manager(object):
    ...
    def train_model(self, encoder, teacher_with_reduction, training_data, seen_des, seen_relations, list_seen_des, is_memory=False):
        ...
        encoder.train()
        teacher_with_reduction.base_teacher.eval()
        ...
        for i in range(epoch):         
            for batch_num, (instance, labels, ind) in enumerate(data_loader):
                ...
                teacher_reduced_output, teacher_full_output = teacher_with_reduction(instance['input'])
    ...
    def train(self):
        ...
        for step, (training_data, valid_data, test_data, current_relations, \
            ...
            self.train_model(encoder, teacher_with_reduction, training_data_initialize, seen_des, seen_relations, list_seen_des, is_memory=False)
