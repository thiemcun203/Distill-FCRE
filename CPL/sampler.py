...
if __name__ == '__main__':
    ...
    sampler = data_sampler_CFRL(config=config)
    for cur_training_data, cur_valid_data, cur_test_data, current_relations,\
        history_test_data, seen_relations in sampler:
        print(current_relations)
        # print(cur_training_data)
        print(cur_valid_data)
        # print(cur_test_data)
        # print(history_test_data)
