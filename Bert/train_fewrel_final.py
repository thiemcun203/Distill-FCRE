...
class Manager(object):
    ...
    def train_model(self, encoder, teacher, training_data, seen_des, seen_relations, list_seen_des, is_memory=False):
    ...
    def train(self):
        ...
        for step, (training_data, valid_data, test_data, current_relations, \
            ...
            wandb.log({'step': step, 'cur_acc': ac1, 'his_acc': ac2, 'cur_acc_des': ac1_des, 'his_acc_des': ac2_des, 'cur_acc_rrf': ac1_rrf, 'his_acc_rrf': ac2_rrf})
...
if __name__ == '__main__':
    ...
    wandb.init(
    project = 'CPL',
    name = f"CPL{args.task_name}_{args.num_k}-shot-SIRUS",
    config = {
        'name': "CPL-SIRUS",
        "task" : args.task_name,
    ...
    for i in range(len(ave)):
        wandb.log({f'his_acc_mean': ave[i], f'his_acc_des_mean': ave1[i], f'his_acc_rrf_mean': ave2[i]})
